...
/**
 * Template de e-mail (HTML inline, responsivo simples).
 * $args:
 *  - site        (string)
 *  - title       (string)
 *  - excerpt     (string)
 *  - permalink   (string URL)
 *  - image       (string URL ou "cid:xxxx")
 *  - unsubscribe (string URL|null)
 */
class ENL_Template
{
  ...
  public static function render(array $args): string
  {
    ...
    $image_tag = '';
    if (!empty($image)) {
      $image_tag = '<tr><td style="padding:8px 24px 16px 24px">
